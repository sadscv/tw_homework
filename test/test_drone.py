...
class TestDrone(unittest.TestCase):
    ...
    def test_init(self):
        ...
        # init with and without file path
        drone1 = Drone()
    ...
    def test_valid_signal(self):
        ...
        self. assertEqual(drone0.valid_signal('plane1 1 1 1'), True)
        self. assertEqual(drone0.valid_signal('plane1 1 1 1 1 2 3 '), True)
        self. assertEqual(drone0.valid_signal('plane1 2 3 4 1 1 1'), True)
        self. assertEqual(drone0.valid_signal('plane1 3 4 5 1 1 1'), True)
        self. assertEqual(drone0.valid_signal('plane1 4 5 6 1 1 1'), True)
    ...
    def test_check(self):
        ...
        #     '''
    # def test_check_with_restriction (self):
    #         ===================
    #        test_check.txt
    #         ===================
    #         plane1 1 1 1
    #         plane1 1 1 1 1 2 3
    #         plane1 2 3 4 1 1 1
    #         plane1 3 4 5 100 100 100
    #         plane1 103 104 105 1 2 3
    #     '''
    #     file1 = 'testcase/test_with_restriction.txt'
    #
    #     drone1 = Drone(filepath=file1)
    #     self.assertEqual(drone1.check(0), 'plane1 0 1 1 1')
    #     self.assertEqual(drone1.check(2), 'plane1 2 3 4 5')
    ...
    #     self.assertEqual(drone1.check(-1), 'invalid input')
    #     self.assertEqual(drone1.check('abc123'), 'invalid input')
    def test_error_time(self):
        file1 = 'testcase/test_error_time.txt'
        file2 = 'testcase/test_ok.txt'
        drone = Drone(filepath=file1)
        drone1 = Drone(filepath=file2)
        self.assertEqual(drone.error_time(), 3)
        self.assertEqual(drone1.error_time(), -1)

    def test_distance(self):
        file1 = 'testcase/test_distance.txt'
        drone1 = Drone(filepath=file1)
        self.assertEqual(drone1.distance(), '2 3 4')


def test_main():
    path0 = 'testcase/test_ok.txt'
    drone = Drone(filepath=path0)
